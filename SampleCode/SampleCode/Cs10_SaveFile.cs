...
namespace SampleCode
{
    ...
    public class Cs10_SaveFile : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            System.IO.FileStream file = new FileStream(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\FileOut.txt", FileMode.Create, FileAccess.ReadWrite);
        ...
        {
            string name = null;
            name = doc.GetElement(elem.LookupParameter("基準約束").AsElementId()).Name;
            return name;
        }
